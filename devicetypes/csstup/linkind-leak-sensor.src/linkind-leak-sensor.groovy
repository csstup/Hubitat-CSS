 ...
 *
 * Get updates from:
 * https://github.com/csstup/Hubitat-CSS/blob/main/devicetypes/csstup/linkind-leak-sensor.src/linkind-leak-sensor.groovy 
 *
 */
...
def configure() {
    ...
    cmds += zigbee.configureReporting(0x0001, 0x0020, DataType.UINT8, 3600, 3600, 1, [:], 200)   // Configure Battery Voltage - Report once per Xhrs or if a change of 1% detected
    cmds += zigbee.configureReporting(0x0001, 0x0021, DataType.UINT8, 3600, 3600, 1, [:], 200)   // Configure Battery Percentage - Report once per Xhrs or if a change of 1% detected
